    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fafafa]" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="w-full max-w-[380px] px-6">
        ...
        <div className="bg-white border border-neutral-200/80 rounded-2xl p-7 shadow-sm">
          ...
          <p className="text-[13px] text-neutral-500 text-center mb-6">Get started in under 30 seconds</p>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="text-[12px] font-medium text-neutral-600 mb-1.5 block">Company Name</label>
              <input
                {...register("name")}
